...
aws_vpc_name = "vpc-delta"     # Name tag for the VPC
env_name     = "qa"            # Environment tag
...
aws_name_subnet_1          = "vpc-delta-public-1" # Name tag for first subnet
aws_name_subnet_2          = "vpc-delta-public-2" # Name tag for second subnet
